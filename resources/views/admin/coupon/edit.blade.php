...
<section class="content">
    ...
    <div class="container-fluid">
        <form method="post" action="" name="DiscountForm" id="DiscountForm" enctype="multipart/form-data">
        <div class="card">
            <div class="card-body">								
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" id="description" cols="30" rows="5" placeholder="Decription">{{ $coupon->description }}</textarea>
                            <p></p>	
                        </div>
                    </div>	 								
                </div>
