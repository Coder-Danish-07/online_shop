                            ...
                            <li class="list-group-item">
                                <div class="row align-items-center">
                                    <div class="col-4 col-md-3 col-xl-2">
                                        ...
                                        @php
                                        $productImage = ProductImage($item->product_id);
                                        @endphp

                                        @if(!empty($productImage->image))
                                        <img src="{{ asset('uploads/product/small/'.$productImage->image)}}" class="img-fluid"  >
                                        @else
                                        <img src="{{asset('admin-assets/img/default-image.png')}}"  class="img-fluid">
                                        @endif
                ...
                <div class="card card-lg mb-5 mt-3">
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            <li class="list-group-item d-flex">
                                <span>Discount {{(!empty($order->coupon_code_id) ? '( '.$order->coupon_code.' )' : '')}}</span>
