		...
		<div class="login-box">
			...
			<div class="card card-outline card-primary">
			  	...
			  	<div class="card-body">
					...
					<form action="<?php echo e(route('admin.authinticate')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
				  		...
				  		<div class="input-group mb-3">
							<input type="password" name="password" value="<?php echo e(old('password')); ?>" id="password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\online_shop\resources\views/admin/login.blade.php ENDPATH**/ ?>